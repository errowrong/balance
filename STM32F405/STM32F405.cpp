...
LQR lqr(-10.90202, -1.2062, -3.8786, -5.1282, 3.69058, 0.8314,
	0.958245, 0.169442, 0.5757072, 0.7563, 0.9290, 0.9305923);
//(-10.94583, -1.9487, -5.0048, -6.1390, 5.06658, 1.3958,
	//0, 0.623787, 4.8366183, 7.2541, 0.8866, 0.8511099);

	
	//(-10.21511, -1.7372, -1.8370, -2.8775, 7.05901, 0.9242,
	//16.869051, 3.662420, 4.4769402, 6.8551, 25.6152, 3.0471350);


//(-10.37432, -1.7430, -1.8320, -2.87223,    5.6861  , 0.9146,
	//1.809700, 1.687962, 1.5576332, 1.9767, 0.9813, 0.8706842);
...
int main(void)
{
	...
	imuChassis.Init(&uart3, USART3, 115200, CH040, NULL);
